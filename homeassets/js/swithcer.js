...
jQuery(document).ready(function () {
  ...
  jQuery(".dark").click(function () {
    ...
    jQuery(".dark").hide();
    jQuery("head").append(
      '<link rel="stylesheet" type="text/css" media="screen" href="homeassets/css/change.css">'
    );
    jQuery("head").append(
      '<link rel="stylesheet" type="text/css" media="screen" href="theme/css/site-change.css">'
    );
    jQuery(".national_emblem").attr(
      "src",
      "homeassets/images/emblem-light.png"
    ); // high contrast

    jQuery(".ico-skip img.top").attr("src", "homeassets/images/ico-skip-y.png");
    jQuery(".ico-skip img.bottom").attr(
      "src",
      "homeassets/images/ico-skip-light.png"
    );

    //jQuery(".ico-social img.top").attr("src","homeassets/images/ico-social-y.png");
    //jQuery(".ico-social img.bottom").attr("src","homeassets/images/ico-social-light.png");

    jQuery(".ico-site-search img.top").attr(
      "src",
      "homeassets/images/ico-site-search-y.png"
    );
    jQuery(".ico-site-search img.bottom").attr(
      "src",
      "homeassets/images/ico-site-search-light.png"
    );

    jQuery(".ico-sitemap img.top").attr(
      "src",
      "homeassets/images/ico-sitemap-y.png"
    );
    jQuery(".ico-sitemap img.bottom").attr(
      "src",
      "homeassets/images/ico-sitemap-light.png"
    );

    jQuery(".ico-accessibility img.top").attr(
      "src",
      "homeassets/images/ico-accessibility-light.png"
    );
    ...
    jQuery(".sw-logo img").attr("src", "homeassets/images/swach-bharat-y.png");
  });
  jQuery(".light").click(function () {
    ...
    jQuery(".national_emblem").attr("src", "homeassets/images/emblem-dark.png"); //normal

    jQuery(".ico-skip img.top").attr("src", "homeassets/images/ico-skip.png");
    jQuery(".ico-skip img.bottom").attr(
      "src",
      "homeassets/images/ico-skip-light.png"
    );

    //jQuery(".ico-social img.top").attr("src","homeassets/images/ico-social.png");
    //jQuery(".ico-social img.bottom").attr("src","homeassets/images/ico-social-light.png");

    jQuery(".ico-site-search img.top").attr(
      "src",
      "homeassets/images/ico-site-search.png"
    );
    jQuery(".ico-site-search img.bottom").attr(
      "src",
      "homeassets/images/ico-site-search-light.png"
    ...
    jQuery(".ico-sitemap img.top").attr(
      "src",
      "homeassets/images/ico-sitemap.png"
    );
    jQuery(".ico-sitemap img.bottom").attr(
      "src",
      "homeassets/images/ico-sitemap-light.png"
    ...
    jQuery(".ico-accessibility img.top").attr(
      "src",
      "homeassets/images/ico-accessibility.png"
    );
    jQuery(".ico-accessibility img.bottom").attr(
      "src",
      "homeassets/images/ico-accessibility-light.png"
    ...
    jQuery(".sw-logo img").attr("src", "homeassets/images/swach-bharat.png");
  });
