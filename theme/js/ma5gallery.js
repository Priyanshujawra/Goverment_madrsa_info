...
$.fn.ma5preload = function () {
  ...
  this.each(function () {
    if (typeof $(this).data("ma5pathtofull") !== "undefined") {
      $(this)
        .clone()
        .attr("src", $(this).data("ma5pathtofull"))
        .appendTo(".ma5-preloadbox");
    } else {
      $(this)
        .clone()
        .attr(
...
function ma5showActive() {
  ...
  if (typeof $(".ma5-active img").data("ma5pathtofull") !== "undefined") {
    var ma5clone = $(".ma5-active img")
      .clone()
      .attr("src", $(".ma5-active img").data("ma5pathtofull"))
      .addClass("ma5-clone");
  } else {
    var ma5clone = $(".ma5-active img")
      .clone()
...
function ma5showFigcaption() {
  if ($(".ma5-active").has("figcaption").length) {
    $(".ma5-figcaption")
      .removeClass("ma5-figcaption")
      .addClass("ma5-figcaption-old");
    $("body").append(
      '<div class="ma5-figcaption"><div class="ma5-centerbox"></div></div>'
    );
    $(".ma5-imgbox").last().addClass("ma5-has-figcaption");
    $(".ma5-active figcaption")
      .contents()
      .clone()
      .appendTo($(".ma5-figcaption .ma5-centerbox"));
  } else {
    $(".ma5-figcaption").addClass("ma5-out");
    setTimeout(function () {
      $(".ma5-figcaption").remove();
...
$.fn.ma5gallery = function (atributes) {
  ...
  $(this).on("touch click", function (event) {
    if (
      !$(".ma5-imgbox").hasClass("ma5-out") &&
      !$("body").hasClass("ma5-in")
    ) {
      if (
        $(this).parent().parent().hasClass("ma5-gallery") ||
        $(this).parent().parent().hasClass("ma5-bg")
      ) {
        // gallery mode
        $(this)
          .parent()
        ...
        $(".ma5-prev").on("touch click", function () {
          if (
            $("body").hasClass("ma5-gallery-active") &&
            !$("body").hasClass("ma5-in")
          ) {
            ma5goPrev();
          }
        ...
        $(thisSelector).on("touch click", function () {
          if (
            !$(this).parent().hasClass("ma5-active") &&
            !$("body").hasClass("ma5-in")
          ) {
